...
class EthernetFrame:
    ...
    def __init__(self, data):
        ...
        # self.destination = data[0:12]
        self.destination = mac_address(data[0:6])
        # self.source = data[0:12]
        self.source = mac_address(data[6:12])
...
class IPHeader:
    ...
    def __init__(self, data):
        ...
        self.source_address = socket.inet_ntoa(unpacked_data[8])
        self.destination_address = socket.inet_ntoa(unpacked_data[9])
        self.leftover_data = data[self.length:]
...
class TCPSegment:
    ...
    def __init__(self, data):
        ...
        self.destination_port = unpacked_data[1]
